...
import type { Game, RoundToGame } from "spicylib/schema";
...
interface TeamChooserProps {
  game: Game;
  teamCount: number;
  initialAssignments?: Map<string, number>;
  onAssignmentsChange: (assignments: Map<string, number>) => void;
  showTossBalls?: boolean;
}
...
export function TeamChooser({
  ...
  }, [allPlayerRounds, teamCount, onAssignmentsChange]);
  ...
  const handleDrop = useCallback(
    ...
    [teamAssignments, onAssignmentsChange],
  );
