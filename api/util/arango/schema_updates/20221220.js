...
const main = async () => {
  try {
    ...
    const twelve = {
      ...
      "based_on": "user",
      "scope": "hole",
      "availability": "{'and': [ {'team_down_the_most': [{'getPrevHole': []},{'var': 'team'}] }, {'existingPreMultiplierTotal': [ {'getCurrHole': []}, 8 ]} ] }",
      "type": "multiplier",
      "default": 12,
      "override": true,
    };
    ...
    try {
      ...
      _id = res._id;
    } catch (error) {} // do nothing if doc exists
    ...
    const custom = {
      ...
      "based_on": "user",
      "scope": "hole",
      "availability": "{ 'team_down_the_most': [{'getPrevHole': []}, {'var': 'team'}] }",
      "type": "multiplier",
      "input_value": true,
      "override": true,
    };
