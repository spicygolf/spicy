...
- ~~deploy new API~~
- E2E test games in CI
- Sandbox -> Staging -> Production for USGA/GHIN access
...
Just recently reworked as light proxy for talking to USGA/GHIN servers.
...
The GHIN code is in the `@spicygolf/ghin` NPM package, and is used to interact with the GHIN API to get handicaps, courses, tee boxes, holes, yards/meters, ratings, slope, etc.  It is a library that can be used by the API and maybe the mobile app.
