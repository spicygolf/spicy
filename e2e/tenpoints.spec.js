describe('SpicyGolf', () => {
  ...
  it('should be able to create new 10 points game', async () => {
    // **************************************
    // create new game
    ...
    await element(by.id('new_72068186')).tap();
...
*/
    ...
    // hole 1 . 3,3,3
    await element(by.id('h_1_t_1_p_1_s_4')).tap();
    await element(by.id('h_1_t_2_p_1_s_5')).tap();
    await element(by.id('h_1_t_3_p_1_s_5')).tap();
    await element(by.id('h_1_t_1_p_1_j_7')) // prox
      .tap();

    // hole 2 . 5,3,1
    await element(by.id('holeNav_next')).tap();
    await element(by.id('h_2_t_1_p_1_j_7')) // prox
      .tap();
    await element(by.id('h_2_t_1_p_1_s_4')).tap();
    await element(by.id('h_2_t_2_p_1_s_5')).tap();
    await element(by.id('h_2_t_3_p_1_s_6')).tap();

    // hole 3 . 4,4,1
    await element(by.id('holeNav_next')).tap();
    await element(by.id('h_3_t_1_p_1_j_7')) // prox
      .tap();
    await element(by.id('h_3_t_1_p_1_s_4')).tap();
    await element(by.id('h_3_t_2_p_1_s_4')).tap();
    await element(by.id('h_3_t_3_p_1_s_5')).tap();

    // hole 4 . 5,2,2
    await element(by.id('holeNav_next')).tap();
    await element(by.id('h_4_t_1_p_1_j_7')) // prox
      .tap();
    await element(by.id('h_4_t_1_p_1_s_4')).tap();
    await element(by.id('h_4_t_2_p_1_s_6')).tap();
    await element(by.id('h_4_t_3_p_1_s_6')).tap();
